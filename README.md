...
| 항목 | 1차(무부하) | 2차(무부하) | 3차(지면) |
|---|---|---|---|
| 정상상태 오차 (좌) | 14.9% | 5.7% | **2.0%** |
| 정상상태 오차 (우) | 13.1% | 4.9% | **1.8%** |
| 90% 도달 | 260 ms | 240 ms | 300 ms |
| 오버슈트 | 0% | 10.0% | 5.3% |
| 좌우 편차 | 2.6 mm/s | 1.2 mm/s | **0.4 mm/s** |
| 정착 듀티 | 744 | 673 | 734 |

잔류 오차 3.0 mm/s는 속도 측정 양자(1.8 mm/s)의 약 1.7배이므로,
추가 튜닝은 플랜트가 아닌 센서 분해능에 맞추는 작업이 된다.

좌우 편차 0.4 mm/s는 0.3% 수준으로, 모터 개체차에 의한 직진 편향은
무시할 수 있다.
